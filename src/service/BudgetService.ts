...
export class BudgetService {
    ...
    private async getBudgetById(factory: RepoFactory, budgetId: string): Promise<BudgetDto|null> {
        const budget = await factory.createBudgetRepo().getBudgetById(budgetId);
